...
cacheTestsE = do
  Enc.mapLensE' .= (fromList [('a',3),('b',5)] :: Map Char Int)
  Enc.mapLensE' .= (fromList [(4,'a'),(7,'b')] :: Map Int Char)
  (tellAE "test0" 3.1416) =<< use (atLensE () . non (3.1416 :: Double))
  (tellAE "test0b" (Nothing :: Maybe Float)) =<< use (Enc.atLensE' @_ @Float ())
  Enc.atLensE' () .= Just (3.1416 :: Float)
  (tellAE "test0c" (Just 3.1416 :: Maybe Float)) =<< use (Enc.atLensE' @_ @Float ())
  (tellAE "test1" (fromList [('a',3),('b',5)])) =<< use (Enc.mapLensE' @Char @Int)
  (tellAE "test2" (Just 5)) =<< use (Enc.atLensE' @Char @Int 'b')
  (tellAE "test3" (Just 5)) =<< use (Enc.mapLensE' @Char @Int . at 'b')
  (tellAE "test4" Nothing) =<< use (Enc.atLensE' @Char @Int 'x')
  (tellAE "a" (fromList [('a',3),('b',5)])) =<< use (Enc.mapLensE' @Char @Int)
  (tellAE "b" (fromList [('a',3),('b',5)])) =<< use (Enc.mapLensE' @Char @Int)
  (tellAE "c" (Just 5)) =<< use (Enc.atLensE' @Char @Int 'b')
  (tellAE "d" (Just 5)) =<< use (Enc.mapLensE' @Char @Int . at 'b')
  (tellAE "e" Nothing) =<< use (Enc.atLensE' @Char @Int 'x')
